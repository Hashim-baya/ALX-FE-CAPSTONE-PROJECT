        ...
        <div className='flex items-center justify-center sm:space-x-96  flex-col sm:flex-row'>
           ...
           <Logo />
            ...
            <div className='flex justify-between items-center flex-col ms-0 w-3/4 mt-4 sm:mt-0 sm:w-1/4'>
                <NavLink to='/' className='text-[#e76f51] text-sm font-extrabold text-center'>HOME</NavLink>
                <NavLink to='/trending' className='text-[#e76f51] text-sm font-extrabold text-center'>TRENDING</NavLink>
                <NavLink to='/tvSeries' className='text-[#e76f51] text-sm font-extrabold text-center'>TV SERIES</NavLink>
                <NavLink to='/movies' className='text-[#e76f51] text-sm font-extrabold text-center'>MOVIES</NavLink>
                <NavLink to='/tvShows' className='text-[#e76f51] text-sm font-extrabold text-center'>TV SHOWS</NavLink>
